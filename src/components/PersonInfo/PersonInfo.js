...
class PersonInfo extends Component {
  //  depending on the person id, I do request operations in this Class !
  ...
  render() {
    ...
    return (
      <>
        <BreadCrumb title={this.props.location.actorName} />
        {loadingPersonMovies || loadingPersonDetails ? (
          <Spinner />
            ...
            <Container fluid="xs">
              <Row className="no-gutters person-info-container ">
                <Col sm={10} className="offset-sm-1">
                  <PersonInfoBar info={personDetails} />
                </Col>
              </Row>
            </Container>
            <Container className="animated fadeIn">
              <PageTitle title="Other Movies" />
              <Row>
              ...
              {visible < personMovies.length ? (
                <LoadMoreBtn
                  ...
                  text={personMovies.length - visible + " " + "Movie More Show"}
                />
              ) : null}
            </Container>
          </>
